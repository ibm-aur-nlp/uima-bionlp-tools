 ...
 */
public class msiFilter implements FeatureFunction {
	public static final String DEFAULT_NAME = "msi";

	static Pattern msiPattern = Pattern
			.compile("(MSI|[mM]icrosatellite instability|SNPs?|[sS]ingle nucleotide polymorphisms?)");
	...
	public List<Feature> apply(Feature feature) {
		...
		if (featureValue == null)
			...
			if (value == null || value.length() == 0)
				return Collections.emptyList();
			if (msiPattern.matcher(value).matches()) {
